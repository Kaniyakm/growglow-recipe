...
export function IngredientsPage() {
    ...
    const filteredIngredients = ingredientsData.filter(ingredient => ingredient.name.toLowerCase().includes(searchQuery.toLowerCase()));
    return (_jsxs("div", { className: "container mx-auto px-4 py-12", children: [_jsxs("div", { className: "mb-8", children: [_jsxs("div", { className: "flex items-center gap-3 mb-3", children: [_jsx(Leaf, { className: "size-10 text-emerald-600" }), _jsx("h1", { className: "text-4xl", children: "SuperFoods List: Fruits & Herbs for Skin and Hair Health" })] }), _jsx("p", { className: "text-gray-600", children: "Discover the natural superfoods that power our wellness recipes and their benefits for your hair and skin" })] }), _jsx("div", { className: "mb-6", children: _jsx("input", { type: "text", placeholder: "Search ingredients...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "w-full max-w-md px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-600" }) }), _jsx("div", { className: "bg-white rounded-xl border overflow-hidden shadow-sm", children: _jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "w-full", children: [_jsx("thead", { className: "bg-emerald-50", children: _jsxs("tr", { children: [_jsx("th", { className: "px-6 py-4 text-left font-semibold text-gray-900 border-r", children: "Fruit/Herb/Nut" }), _jsx("th", { className: "px-6 py-4 text-left font-semibold text-gray-900 border-r min-w-[250px]", children: "Primary Hair Benefits" }), _jsx("th", { className: "px-6 py-4 text-left font-semibold text-gray-900 border-r min-w-[250px]", children: "Primary Skin Benefits" }), _jsx("th", { className: "px-6 py-4 text-left font-semibold text-gray-900 min-w-[200px]", children: "Key Nutrients" })] }) }), _jsx("tbody", { className: "divide-y divide-gray-200", children: filteredIngredients.map((ingredient, index) => (_jsxs("tr", { className: "hover:bg-gray-50 transition-colors", children: [_jsx("td", { className: "px-6 py-4 font-medium text-gray-900 border-r", children: ingredient.name }), _jsx("td", { className: "px-6 py-4 text-sm text-gray-700 border-r", children: ingredient.hairBenefits }), _jsx("td", { className: "px-6 py-4 text-sm text-gray-700 border-r", children: ingredient.skinBenefits }), _jsx("td", { className: "px-6 py-4 text-sm text-gray-600", children: ingredient.keyNutrients })] }, index))) })] }) }) }), _jsx("div", { className: "mt-6 text-sm text-gray-600", children: _jsxs("p", { children: ["Showing ", filteredIngredients.length, " of ", ingredientsData.length, " natural ingredients"] }) })] }));
}
