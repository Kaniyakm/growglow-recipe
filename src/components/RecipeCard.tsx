...
export function RecipeCard({ recipe, index, onClick }: Props) {
  ...
  return (
    <div style={{ perspective: '1000px', height: '420px', animationDelay: `${index * 0.05}s` }}
      className="w-full">
      <div style={{
          ...
          <div className="p-5 flex flex-col flex-1">
            ...
            <div className="flex items-center justify-between text-sm text-gray-500 border-t pt-3 mt-auto">
              <div className="flex items-center gap-1">
                ...
                <span>{recipe.time}</span>               {/* ✅ YOUR field */}
              </div>
        ...
        <div style={{ backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden', transform: 'rotateY(180deg)' }}
          ...
          <div className={`bg-gradient-to-br ${CATEGORY_COLOR[recipe.category]} p-5 flex-shrink-0`}>
            <div className="flex items-start justify-between">
              <div>
                <p className="text-white/80 text-xs font-medium uppercase tracking-widest mb-1">Ingredients</p>
                <h3 className="text-white font-semibold text-base line-clamp-2">{recipe.title}</h3>
              </div>
